...
namespace sict {
    ...
    /*
     Query that stores obj's data into a file. */
    ...
    /*
     Loads data from a file into an obj. */
    ...
    int NonPerishable::operator+=(int i) { return (i > 0) ? stockQty += i : stockQty; }
    /*
