...
int main() {
	...
	for (int i = 0; i < count; ++i) {
        ...
        cout << "Enter the number of people living in "
             << pKingdom[i].m_name << ": ";
    ...
    cout << "Enter the name of the Kingdom: ";
    cin  >> pKingdom[count + 1].m_name;
    cin.ignore(2000, '\n');

    cout << "Enter the number of people living in " << pKingdomPlus[count + 1].m_name << ": ";
    cin  >> pKingdom[count + 1].m_population;
    cin.ignore(2000, '\n');
